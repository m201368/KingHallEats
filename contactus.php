  ...
  <div class="container">
    <div class="row text-center">
      <div class="col-md-8 col-md-offset-2">
        ...
        <h4>Fill out the form below with questions, comments, concerns and we will get back to you ASAP.</h4>
      </div>
    </div>
  </div>
  <div class="container">
      ...
      <div class="col-md-8 col-md-offset-2">
        <form action="mailto:m190354@usna.edu" enctype="text/plain">
          <div class="form-group">
            ...
            <textarea class="form-control" name="feedback" rows="4"placeholder="Questions, Comments, Concerns"></textarea>
            <input type="submit" class="form-control" value="Submit Feedback">
          </div>
        </form>
      </div>
    </div>
